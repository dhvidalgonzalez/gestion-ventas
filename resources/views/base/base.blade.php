...
<head>
  ...
  <title>@yield('title', 'Gestión de Ventas')</title>
  ...
  <!-- Template Styles -->
  <link href="{{ asset('assets/css/theme.min.css') }}" id="style-default" rel="stylesheet">
  <link href="{{ asset('assets/css/user.min.css') }}" id="user-style-default" rel="stylesheet">
  <link href="{{ asset('assets/css/theme-rtl.min.css') }}" id="style-rtl" rel="stylesheet">
  <link href="{{ asset('assets/css/user-rtl.min.css') }}" id="user-style-rtl" rel="stylesheet">
  ...
  <body>
    ...
    <main class="main" id="top">
     @include('menu.menu')     {{-- Menú lateral --}}
     @include('header.header') {{-- Header superior --}}
